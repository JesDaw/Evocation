...
public class CharacterStatBalancer : MonoBehaviour
{
        ...
        float powerOffset)
    {
        ...
        float rawPower = SimulatePower(
            Stats._AttackDamage, Stats._AttackEndlag, Stats._MoveSpeed, Stats._KnockBackDamage, Stats._MaxHealth, Stats._KnockBackMaxHealth, Stats._HorizontalRange,
        ...
        float myFreq = 1f / (Mathf.Max(Stats._AttackEndlag * wEnd, 0.01f) + 0.5f);
    ...
    private void UpdateCurves(float wAtk, float wEnd, float wMove, float wKB_Dmg, float wHP, float wKB_HP, float wRange, float avgHP, float avgKB_HP, float avgMove, float avgKB_Dmg, float avgAtk, float avgEndlag, float avgRange, float baseVelocity, float simDist, float mMove, float mEnd, float mRange, float mHP, float mAtk, float mKBD, float mKBH)
    {
        ...
        {
            float t = i / (float)res;
            Power_Curves.MoveSpeed.AddKey(t * mMove, SimulatePower(Stats._AttackDamage, Stats._AttackEndlag, t * mMove, Stats._KnockBackDamage, Stats._MaxHealth, Stats._KnockBackMaxHealth, Stats._HorizontalRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
            ...
            Power_Curves.HorizontalRange.AddKey(t * mRange, SimulatePower(Stats._AttackDamage, Stats._AttackEndlag, Stats._MoveSpeed, Stats._KnockBackDamage, Stats._MaxHealth, Stats._KnockBackMaxHealth, t * mRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
            Power_Curves.MaxHealth.AddKey(t * mHP, SimulatePower(Stats._AttackDamage, Stats._AttackEndlag, Stats._MoveSpeed, Stats._KnockBackDamage, t * mHP, Stats._KnockBackMaxHealth, Stats._HorizontalRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
            Power_Curves.AttackDamage.AddKey(t * mAtk, SimulatePower(t * mAtk, Stats._AttackEndlag, Stats._MoveSpeed, Stats._KnockBackDamage, Stats._MaxHealth, Stats._KnockBackMaxHealth, Stats._HorizontalRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
            Power_Curves.KnockBackDamage.AddKey(t * mKBD, SimulatePower(Stats._AttackDamage, Stats._AttackEndlag, Stats._MoveSpeed, t * mKBD, Stats._MaxHealth, Stats._KnockBackMaxHealth, Stats._HorizontalRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
            Power_Curves.KnockBackMaxHealth.AddKey(t * mKBH, SimulatePower(Stats._AttackDamage, Stats._AttackEndlag, Stats._MoveSpeed, Stats._KnockBackDamage, Stats._MaxHealth, t * mKBH, Stats._HorizontalRange, wAtk, wEnd, wMove, wKB_Dmg, wHP, wKB_HP, wRange, avgHP, avgKB_HP, avgMove, avgKB_Dmg, avgAtk, avgEndlag, avgRange, baseVelocity, simDist));
        }
    }
